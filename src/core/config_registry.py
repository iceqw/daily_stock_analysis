...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "DEEPSEEK_API_KEY": {
        ...
        "description": "Official DeepSeek API key (from https://platform.deepseek.com). New configs default to deepseek/deepseek-v4-flash. For legacy compatibility, deepseek-chat/deepseek-reasoner still work but are deprecated after 2026-07-24. Also works in multi-channel mode.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "NOTIFICATION_DEDUP_TTL_SECONDS": {
        ...
        "description": "Suppress duplicate static notifications with the same dedup key within this TTL (seconds). Default 3600 (1 hour). Set to 0 to disable deduplication.",
        "category": "notification",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "NOTIFICATION_COOLDOWN_SECONDS": {
        ...
        "description": "Suppress repeated static notifications with the same cooldown key during this window (seconds). Default 600 (10 minutes). Set to 0 to disable cooldown.",
        "category": "notification",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
